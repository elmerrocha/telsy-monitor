...
def serial_write(command):
    ...
    commands = {
        ...
        2  : [0x42, 0x80, 0x80, 0xC2], #Patient type: Adult [default]
        ...
        6  : [0x45, 0x80, 0x81, 0xC6], #3/5 lead system: 5 lead [default]
        ...
        10 : [0x47, 0x80, 0x80, 0xC7], #ECG filter mode: Diagnostic (0.05-130Hz) [default]
        11 : [0x47, 0x80, 0x81, 0xC8], #ECG filter mode: Monitor (0.5-40Hz)
        12 : [0x47, 0x80, 0x82, 0xC9], #ECG filter mode: Surgery (1-20Hz)
        13 : [0x48, 0x80, 0x80, 0xC8], #ECG gain: x0.25
        14 : [0x48, 0x80, 0x81, 0xC9], #ECG gain: x0.5
        15 : [0x48, 0x80, 0x82, 0xCA], #ECG gain: x1.0 [default]
        16 : [0x48, 0x80, 0x83, 0xCB], #ECG gain: x2.0
        17 : [0x49, 0x80, 0x80, 0xC9], #ECG Calibration: off [default]
        18 : [0x49, 0x80, 0x81, 0xCA], #ECG Calibration: on
        19 : [0x4A, 0x80, 0x80, 0xCA], #ECG notch: off [default]
        20 : [0x4A, 0x80, 0x81, 0xCB], #ECG notch: on
        21 : [0x4B, 0x80, 0x80, 0xCB], #Pace: off [default]
        22 : [0x4B, 0x80, 0x81, 0xCC], #Pace: on
        23 : [0x50, 0x80, 0x80, 0xD0], #RESP gain: x0.25
        24 : [0x50, 0x80, 0x81, 0xD1], #RESP gain: x0.5
        25 : [0x50, 0x80, 0x82, 0xD2], #RESP gain: x1.0 [default]
        26 : [0x50, 0x80, 0x83, 0xD3], #RESP gain: x2.0
        27 : [0x50, 0x80, 0x84, 0xD4], #RESP gain: x4.0
        28 : [0x51, 0x80, 0x80, 0xD1], #RESP lead: lead I
        29 : [0x51, 0x80, 0x81, 0xD2], #RESP lead: lead II [default]
        30 : [0x53, 0x80, 0x80, 0xD3], #Temp sensor type: 2.5kOhm [default]
        31 : [0x53, 0x80, 0x81, 0xD4], #Temp sensor type: 10kOhm
        32 : [0x54, 0x80, 0x81, 0xD5], #SPO2 sensitivity: High
        33 : [0x54, 0x80, 0x82, 0xD6], #SPO2 sensitivity: Medium [default]
        34 : [0x54, 0x80, 0x83, 0xD7], #SPO2 sensitivity: Low
        35 : [0x55, 0xD5], #NIBP start *************
        36 : [0x56, 0xD6], #NIBP stop
        37 : [0x57, 0x80, 0x80, 0xD7], #NIBP auto period: manual [default]
